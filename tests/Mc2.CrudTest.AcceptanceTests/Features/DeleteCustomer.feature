Feature: Delete Customer
    ...
    Scenario: Successfully delete an existing customer
        Given a customer exists in the system with ID "11111111-1111-1111-1111-111111111111" while deleting a customer
    ...
    Scenario: Attempt to delete a non-existing customer
        Given no customer exists in the system with ID "22222222-2222-2222-2222-222222222222" while deleting a customer
